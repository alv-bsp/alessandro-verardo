 ...
 */
{
	...
	DOM.contentElems = Array.from(document.querySelectorAll('.content-animated-bg'));
	...
	const init = function () {
		...
		window.addEventListener('mousemove', throttle(function (ev) {
			...
			parallaxbg.style.WebkitTransform = 'perspective(1000px) translate3d(' + transX + 'px,' + transY + 'px,' + transZ + 'px) rotate3d(' + xVal + ',' + yVal + ',0,2deg)';
			parallaxbg.style.transform = 'perspective(1000px) translate3d(' + transX + 'px,' + transY + 'px,' + transZ + 'px) rotate3d(' + xVal + ',' + yVal + ',0,2deg)';
		}, 100));
	}
